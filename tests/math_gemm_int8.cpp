...
TEST(gemm_int8, avx256_quad_64)
{
    constexpr std::size_t  size  = 64;
    constexpr optimization optim = optimization::avx256;

    auto Aal = matrix_aligned<std::int8_t, size, size, optim>::get_rand_matrix(0., 2.);
    auto Bal = matrix_aligned<std::int8_t, size, size, optim>::get_rand_matrix(0., 2.);
    auto Cal = matrix_aligned<std::int8_t, size, size, optim>::get_rand_matrix(0., 2.);
...
TEST(gemm_int8, avx256_64_128_64)
{
    ...
    auto Aal
        = matrix_aligned<std::int8_t, sizeRows, sizeOtherColumns, optim>::get_rand_matrix(0., 2.);
    auto Bal = matrix_aligned<std::int8_t, sizeOtherColumns, sizeColumns, optim>::get_rand_matrix(
        0., 2.);
...
TEST(gemm_int8, avx512_64_128_64)
{
    constexpr std::size_t  sizeRows         = 64;
    constexpr std::size_t  sizeOtherColumns = 128;
    constexpr std::size_t  sizeColumns      = 64;
...
TEST(gemm_int8, openmp_avx512_blocked_64_128_64)
{
    constexpr std::size_t  sizeRows         = 128;
    constexpr std::size_t  sizeOtherColumns = 256;
    constexpr std::size_t  sizeColumns      = 128;
