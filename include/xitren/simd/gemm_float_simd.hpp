...
class gemm_core<Rows, Other, Columns, float, optimization::avx256> {
...
public:
    static void
    mult(float const* a, float const* b, float* c)
    {
...
template <std::uint_fast32_t Rows, std::uint_fast32_t Other, std::uint_fast32_t Columns>
class gemm_core<Rows, Other, Columns, float, optimization::openmp_avx512_blocked> {
